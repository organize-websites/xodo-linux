...
import 'package:xodoracoes/caes.dart';
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Container(
                                      child: Center(child: TextButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => Caes()));}, child: FaIcon(FontAwesomeIcons.dog, size: 40, color: Colors.white,),))
                                    )
                                  )
                                )
                              ),
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Container(
                                      child: FaIcon(FontAwesomeIcons.cat, size: 40, color: Colors.white,)
                                    )
                                  )
                                )
                              ),
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Container(
                                      child: FaIcon(FontAwesomeIcons.fish, size: 40, color: Colors.white,)
                                    )
                                  )
                                )
                              ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FaIcon(FontAwesomeIcons.shoppingBag, size: 35, color: Colors.white,),
                                          ),
                                          Text('Faça Seu Pedido', style: TextStyle(color: Colors.white, fontSize: 20),),
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: FaIcon(FontAwesomeIcons.angleRight, size: 35, color: Colors.white,),
                                          ),
                                        ],
                                      )
                                    )
                                    ...
                                    child: Container(
                                      child: Row(
                                        ...
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: FaIcon(FontAwesomeIcons.user, size: 35, color: Colors.white,),
                                          ),
                                          Text('Minha Conta', style: TextStyle(color: Colors.white, fontSize: 20),),
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: FaIcon(FontAwesomeIcons.angleRight, size: 35, color: Colors.white,),
                                          ),
                ...
                delegate: SliverChildListDelegate(
                  [
                    Padding(
                      ...
                      child: Text('Produtos Recentes', style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.w600), textAlign: TextAlign.center,),
                    ),
                  ]
                )
              ),
